...
version 18                  // override per fork in CLAUDE.md
clear all
set more off
set varabbrev off
capture log close
...
* Set to 1 to run pilot / sandbox analyses from the private workspace. Off by
* default to keep the production pipeline fast and deterministic.
local RUN_EDA = 0
